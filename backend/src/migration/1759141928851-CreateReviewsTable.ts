...
export class CreateReviewsTable1759141928851 implements MigrationInterface {
    name = 'CreateReviewsTable1759141928851'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "reviews" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "productId" integer NOT NULL, "rating" integer NOT NULL, "title" text NOT NULL, "comment" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_231ae565c273ee700b283f15c1d" PRIMARY KEY ("id"))`);
